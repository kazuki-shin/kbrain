...
| [slack-to-brain](../../recipes/slack-to-brain.md) | Sense | credential-gateway | Slack channels, threads, and shared links sync into searchable brain pages | 20 min |
| [gdrive-to-brain](../../recipes/gdrive-to-brain.md) | Sense | credential-gateway | Google Docs, Sheets, and Slides sync into searchable brain pages with section-level splitting | 20 min |
